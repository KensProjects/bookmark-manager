...
CREATE TABLE "new_Bookmark" (
    ...
    "name" TEXT DEFAULT 'New Bookmark',
    "url" TEXT NOT NULL,
...
INSERT INTO "new_Bookmark" ("createdAt", "createdById", "id", "name", "updatedAt", "url") SELECT "createdAt", "createdById", "id", "name", "updatedAt", "url" FROM "Bookmark";
DROP TABLE "Bookmark";
